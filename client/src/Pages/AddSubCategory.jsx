...
const AddSubCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const{categoryname,subcategoryname,status,sequence,image}=category

    if(!categoryname|| !subcategoryname|| !status|| !sequence|| !image){
    ...
    formData.append('subcategoryname',category.subcategoryname)
    ...
    try {
      const response = await fetch('http://localhost:3001/add-sub-category', {
        method: 'POST',
        body: formData
      });
  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="">
        <div className="p-5">
          <h2 className="text-2xl font-bold mb-6 ">Add Sub Category</h2>
